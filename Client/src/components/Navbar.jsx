...
const Navbar = () => {
  ...
  const [isSearchOpen, setIsSearchOpen] = useState(false); // For search input visibility
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={`fixed top-0 left-0 h-full bg-black bg-opacity-90 backdrop-blur-md z-50 transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} w-64 p-5 duration-300`}>
        ...
        <div className='mt-6'>
          {/* Category Buttons */}
          <div
            onClick={() => { setCategory('all'); toggleMenu(); }}
            className={`text-white py-2 px-4 mb-2 rounded-full cursor-pointer transition duration-300 ease-in-out ${
              category === 'all' ? 'bg-green-500 text-black' : 'bg-black hover:bg-white hover:text-black'
            }`}
          >
            All
          </div>
          <div
            onClick={() => { setCategory('music'); toggleMenu(); }}
            className={`text-white py-2 px-4 mb-2 rounded-full cursor-pointer transition duration-300 ease-in-out ${
              category === 'music' ? 'bg-green-500 text-black' : 'bg-black hover:bg-white hover:text-black'
            }`}
          >
            Music
          </div>
          <div
            onClick={() => { setCategory('podcast'); toggleMenu(); }}
            className={`text-white py-2 px-4 mb-2 rounded-full cursor-pointer transition duration-300 ease-in-out ${
              category === 'podcast' ? 'bg-green-500 text-black' : 'bg-black hover:bg-white hover:text-black'
            }`}
          >
            Podcasts
          </div>
        ...
        <div className="mt-6">
          ...
          <Link to='/create-playlist' onClick={toggleMenu}>
          ...
          <Link to='/browse-podcasts' onClick={toggleMenu}>
            <div className='text-white py-2 px-4 mb-2 rounded-full cursor-pointer transition duration-300 ease-in-out hover:bg-white hover:text-black'>
              Browse Podcasts
            </div>
          </Link>
      ...
      <div className='hidden md:flex items-center gap-2 mt-4'>
        ...
        <p
          ...
          className={`px-4 py-1 rounded-2xl cursor-pointer transition duration-300 ease-in-out ${category === 'all' ? 'bg-green-500 text-black' : 'bg-black text-white hover:bg-white hover:text-black'}`}
        >
          All
        </p>
        <Link to=''>
          <p
            ...
            className={`px-4 py-1 rounded-2xl cursor-pointer transition duration-300 ease-in-out ${category === 'music' ? 'bg-green-500 text-black' : 'bg-black text-white hover:bg-white hover:text-black'}`}
          >
            Music
          </p>
        </Link>
        <p
          ...
          className={`px-4 py-1 rounded-2xl cursor-pointer transition duration-300 ease-in-out ${category === 'podcast' ? 'bg-green-500 text-black' : 'bg-black text-white hover:bg-white hover:text-black'}`}
        >
          Podcasts
        </p>
      </div>
